...
using TrainingSolution.MinimalApi;
...
{
    var urlExternalAPI = "https://wiredbraincoffee.azurewebsites.net/api/OrderSystemStatus";
    var client = factory.CreateClient();
    var response = await client.GetFromJsonAsync<OrderSystemStatus>(urlExternalAPI);
...
app.MapPut("/orders/{id}", (int id, Order updateOrder, IOrderService orderService) =>
{
